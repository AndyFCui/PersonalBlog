...
const AdminResumeEditor = lazy(() => import('@/pages/admin/resume-editor').then(m => ({ default: m.AdminResumeEditor })))
      ...
      <AuthProvider>
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/admin/resume" element={<AdminLayout><AdminResumeEditor /></AdminLayout>} />
