...
- Name: tests/resume-editor-main.spec.ts >> AdminResumeEditor - Tab Navigation >> shows four tabs
- Location: tests/resume-editor-main.spec.ts:14:3
...
Locator: locator('button:has-text("Main Info")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Main Info")')
